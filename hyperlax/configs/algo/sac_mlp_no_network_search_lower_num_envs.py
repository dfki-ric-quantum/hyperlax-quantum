...
def get_base_hyperparam_distributions() -> dict[str, Any]:
    return {
        ...
        "algorithm.hyperparam.total_num_envs": Categorical(values=[64, 128, 256]),
        "algorithm.hyperparam.rollout_length": Categorical(values=[4, 8, 16]),
        ...
        "algorithm.hyperparam.total_batch_size": Categorical(values=[32, 64, 128]),
        ...
        "algorithm.network.actor_network.pre_torso.layer_sizes": Categorical(values=[[64, 64]]),
        ...
        "algorithm.network.critic_network.pre_torso.layer_sizes": Categorical(values=[[64, 64]]),
