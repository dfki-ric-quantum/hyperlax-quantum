...
def get_base_hyperparam_distributions() -> dict[str, Any]:
    return {
        ...
        "algorithm.hyperparam.num_minibatches": Categorical(values=[8]),
        "algorithm.hyperparam.total_num_envs": Categorical(values=[32]),
        # vec booleans
        ...
        # network hyperparams
        "algorithm.network.actor_network.pre_torso.num_layers": UniformDiscrete(domain=(1, 4)),
        ...
        "algorithm.network.critic_network.pre_torso.num_layers": UniformDiscrete(domain=(1, 4)),
...
def get_base_hyperparam_distributions_test_quick() -> dict[str, Any]:
    return {
        ...
        "algorithm.hyperparam.epochs": Categorical(values=[1]),
        "algorithm.hyperparam.num_minibatches": Categorical(values=[1]),
