...
from hyperlax.base_types import Observation, ObservationGlobalState, State
...
def merge_space(
    ...
    err = (
        f"Unsupported space for merging spaces, expected Box or Discrete, got {type(single_spec)}"
    )
...
class JaxMarlWrapper(Wrapper):
    ...
    def __init__(
        ...
        homogenous_error = (
            f"only supportting environments with homogeneous agents, "
